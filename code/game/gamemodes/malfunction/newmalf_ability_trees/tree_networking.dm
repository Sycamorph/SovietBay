...
/datum/game_mode/malfunction/verb/system_override()
	...
	command_announcement.Announce("Ќаши системные администраторы сообщили, что мы были отрезаны от управлени&#255; вашей сетью.  то бы ни сделал это, он теперь имеет полный контроль над системами станции.", "÷ентр управлени&#255; сетью")
